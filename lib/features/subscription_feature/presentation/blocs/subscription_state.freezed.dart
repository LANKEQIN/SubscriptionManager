...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(final List<Subscription> subscriptions)
...
abstract class Loaded implements SubscriptionState {
  const factory Loaded(final List<Subscription> subscriptions) = _$LoadedImpl;
