...
class _$SubscriptionImpl implements _Subscription {
  ...
  @override
  String toString() {
    return 'Subscription(id: $id, name: $name, price: $price, currency: $currency, billingCycle: $billingCycle, nextRenewalDate: $nextRenewalDate, icon: $icon, color: $color, notes: $notes, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
